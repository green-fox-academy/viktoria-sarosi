...
public class Anagram {
    public static void main(String[] args) throws AtLeastOneOfTheWordsIsMissingException {
    ...
    public static boolean isThisAnAnagram(String first, String second) throws AtLeastOneOfTheWordsIsMissingException {
        if(first == null || second == null){
            throw new AtLeastOneOfTheWordsIsMissingException();
        }
        first.toLowerCase();
        second.toLowerCase();
